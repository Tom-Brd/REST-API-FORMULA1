...
INSERT INTO `drivers` (`name`, `nationality`, `date_of_birth`, `team_id`, `car_number`) VALUES
    ('Lewis Hamilton', 'British', '1985-01-07', 1, 44),
    ('Valtteri Bottas', 'Finnish', '1989-08-28', 1, 77),
    ('Sebastian Vettel', 'German', '1987-07-03', 2, 5),
    ('Charles Leclerc', 'Monegasque', '1997-10-16', 2, 16),
    ('Max Verstappen', 'Dutch', '1997-09-30', 3, 33),
    ('Alexander Albon', 'Thai', '1996-03-23', 3, 23),
    ('Sergio Perez', 'Mexican', '1990-01-26', 7, 11),
    ('Lance Stroll', 'Canadian', '1998-10-29', 7, 18),
    ('Daniel Ricciardo', 'Australian', '1989-07-01', 4, 3),
    ('Esteban Ocon', 'French', '1996-09-17', 4, 31),
    ('Pierre Gasly', 'French', '1996-02-07', 9, 10),
    ('Daniil Kvyat', 'Russian', '1994-04-26', 9, 26),
    ('Kimi Raikkonen', 'Finnish', '1979-10-17', 8, 7),
    ('Antonio Giovinazzi', 'Italian', '1993-12-14', 8, 99),
    ('Romain Grosjean', 'French', '1986-04-17', 5, 8),
    ('Kevin Magnussen', 'Danish', '1992-10-05', 5, 20),
    ('George Russell', 'British', '1998-02-15', 10, 63),
    ('Nicholas Latifi', 'Canadian', '1995-06-29', 10, 6);