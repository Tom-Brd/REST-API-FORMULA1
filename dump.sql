...
INSERT INTO `drivers` (`name`, `nationality`, `date_of_birth`, `team_id`, `car_number`) VALUES
    ...
    ('Sergio Perez', 'Mexican', '1990-01-26', 4, 11),
    ('Lance Stroll', 'Canadian', '1998-10-29', 4, 18),
    ('Daniel Ricciardo', 'Australian', '1989-07-01', 5, 3),
    ('Esteban Ocon', 'French', '1996-09-17', 5, 31),
    ('Pierre Gasly', 'French', '1996-02-07', 6, 10),
    ('Daniil Kvyat', 'Russian', '1994-04-26', 6, 26),
    ('Kimi Raikkonen', 'Finnish', '1979-10-17', 7, 7),
    ('Antonio Giovinazzi', 'Italian', '1993-12-14', 7, 99),
    ('Romain Grosjean', 'French', '1986-04-17', 8, 8),
    ('Kevin Magnussen', 'Danish', '1992-10-05', 8, 20),
